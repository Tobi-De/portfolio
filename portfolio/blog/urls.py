...
urlpatterns = [
    ...
    path("post-detail/<str:slug>/", PostDetailView.as_view(), name="post_detail",),
    path(
    ...
    path(
        "series-detail/<str:slug>/", SeriesDetailView.as_view(), name="series_detail",
    ),
    path(
        "series-update/<str:slug>/", SeriesUpdateView.as_view(), name="series_update",
    ),
    path(
        "series-delete/<str:slug>/", SeriesDeleteView.as_view(), name="series_delete",
    ),
