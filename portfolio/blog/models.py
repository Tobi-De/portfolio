...
from portfolio.core.templatetags.core_tags import markdown
from portfolio.core.utils import get_current_domain_url
from portfolio.newsletter.models import News
...
class Series(Postable, StatusModel, TimeStampedModel, SoftDeletableModel):
    ...
    @property
    def reading_time(self):
        all_posts_reading_time = [post.reading_time for post in self.published_post()]
